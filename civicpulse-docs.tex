...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s2_login.jpg}
\caption{Login — Google OAuth + email magic link}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s3_report_top.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s4_report_bottom.jpg}
\caption{Report page — image upload, webcam, GPS map}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s5_dashboard.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s7_community_review.jpg}
\caption{Community verification — verify/deny panel}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s8_admin_inbox.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s9_admin_map.jpg}
\caption{Admin map — India-wide issue clusters}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s10_agent5.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s11_route_planner.jpg}
\caption{Route Planner — cluster selection + TSP route}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{s12_agent2_map.jpg}
